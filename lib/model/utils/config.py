...
#
__C.TRAIN = edict()
__C.RPN_Attention = False
# Initial learning rate
__C.TRAIN.LEARNING_RATE = 0.001


__C.TRAIN.USE_META_HEAD = True
...
__C.TRAIN.BASECLASSES_FIRST = ['airplane', 'airport', 'dam', 'Expressway-Service-area', 'Expressway-toll-station',
                      'harbor', 'golffield',  'groundtrackfield', 'overpass', 'stadium',
                      'storagetank', 'tenniscourt', 'trainstation', 'vehicle', 'windmill']

__C.TRAIN.ALLCLASSES_SECOND = ['baseballfield', 'basketballcourt', 'bridge', 'chimney', 'dam',
                      'Expressway-Service-area', 'golffield', 'overpass', 'ship', 'stadium',
                      'storagetank', 'tenniscourt', 'trainstation', 'vehicle', 'windmill',
                      'airplane', 'airport', 'Expressway-toll-station', 'harbor', 'groundtrackfield']

__C.TRAIN.BASECLASSES_SECOND = ['baseballfield', 'basketballcourt', 'bridge', 'chimney', 'dam',
                      'Expressway-Service-area', 'golffield', 'overpass', 'ship', 'stadium',
                      'storagetank', 'tenniscourt', 'trainstation', 'vehicle', 'windmill']

__C.TRAIN.ALLCLASSES_THIRD = ['airplane', 'airport', 'baseballfield', 'basketballcourt', 'bridge',
...
__C.TRAIN.BASECLASSES_THIRD = ['airplane', 'airport', 'baseballfield', 'basketballcourt', 'bridge',
                     'chimney', 'Expressway-Service-area', 'Expressway-toll-station',  'harbor','groundtrackfield',
                     'overpass', 'ship', 'stadium', 'trainstation', 'windmill']
__C.TRAIN.ALLCLASSES_FOURTH = ['airplane', 'airport','baseballfield', 'basketballcourt', 'bridge',
...
__C.TRAIN.BASECLASSES_FOURTH = ['airplane', 'airport','baseballfield', 'basketballcourt', 'bridge',
                      'chimney', 'dam', 'Expressway-toll-station',  'harbor', 'golffield',
                      'groundtrackfield', 'ship','storagetank', 'tenniscourt', 'vehicle']
__C.TRAIN.ALLCLASSES_FSODM = [ 'airport', 'basketballcourt', 'bridge', 'chimney', 'dam',
...
__C.TRAIN.BASECLASSES_FSODM = ['airport', 'basketballcourt', 'bridge', 'chimney', 'dam',
                      'Expressway-Service-area', 'Expressway-toll-station',  'harbor', 'golffield',  'groundtrackfield',
                      'overpass', 'ship', 'stadium', 'storagetank', 'vehicle']
####
# Momentum
